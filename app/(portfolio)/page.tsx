...
export default function Home() {
  return (
    <div>
      ...
      <div className="mt-8 text-2xl font-light tracking-wider leading-10">As a fun project I decided to deploy this site using trending technologies and services including Kubernetes, AWS, Terraform, Docker, Github, NextJS, and much more.  Please visit the <a className="tracking-tight underline" href='/tech'>tech stack page</a> for more details.</div>
    </div>
  );
}
